...
export default function Landing() {
  ...
  <p className="text-green-700 mt-2">
    ...
    അല്ലാഹു പറയുന്നു: <br />
    <span className="font-semibold">"തീർച്ചയായും അല്ലാഹുവും അവന്റെ മലക്കുകളും നബിക്ക് സ്വലാത്ത് ചൊല്ലുന്നു. 
    സത്യവിശ്വാസികളേ, നിങ്ങളും അവിടുത്തേക്ക് സ്വലാത്തും സലാമും ചൊല്ലുക."</span>
  </p>
  <p className="text-green-700 mt-2">
